  ...
  return (
    <View style={styles.container}>
      <View style={styles.actions}>
        ...
        <TouchableOpacity style={styles.actionBtn} onPress={() => navigation.navigate('Recommendations')}>
...
const styles = StyleSheet.create({
  ...
  card: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', margin: 12, marginBottom: 0, borderRadius: 10, padding: 14, elevation: 1 },
  cardContent: { flex: 1 },
  ...
  qtyBtn: { width: 28, height: 28, borderRadius: 14, backgroundColor: '#e5e7eb', justifyContent: 'center', alignItems: 'center' },
  qtyBtnDisabled: { opacity: 0.4 },
  qtyBtnText: { fontSize: 16, fontWeight: '700', color: '#374151', lineHeight: 18 },
  qtyValue: { fontSize: 15, fontWeight: '600', color: '#111827', minWidth: 24, textAlign: 'center', marginHorizontal: 6 },
